package come.npu.libraryapp.restclient;
...
public class StudentServicesClient {
	...
	private static String STUDENT_SERVICES_URL = "http://localhost:8080/libraryapp/webservices/student/";
	...
	public static Student createNewStudent() {
		...
		stud.setPhoneNumber("408-408-4088");
		return stud;
	}

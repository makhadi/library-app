...
<center>
<h1><fmt:message key="profileUpdateForm.title" /></h1>

  <form:form action="./processupdateprofileform" method="POST" commandName="librarian">
  <table>
  	<tr>
        <td><form:input path="librarianId" type="hidden"/>
        </td>
    </tr>
  	<tr>
